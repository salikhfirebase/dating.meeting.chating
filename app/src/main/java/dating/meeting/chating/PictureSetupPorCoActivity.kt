...
class PictureSetupPorCoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_picture_setup_por_co)

        the_imgHolder = findViewById(R.id.chosen_by_tropa_sf_picture)
        the_takePicButt = findViewById(R.id.take_a_dfv_some_button)
        the_selectImgButton = findViewById(R.id.choose_pic_from_gallery_riiie_user)
        the_nextButton = findViewById(R.id.picture_rf_pomo_next_button)
