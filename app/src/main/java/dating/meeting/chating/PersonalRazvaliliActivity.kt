...
import kotlinx.android.synthetic.main.activity_personal_razvalili.*
import kotlinx.android.synthetic.main.app_bar_user_profile.*
import dating.meeting.chating.db.AppDatabase
import dating.meeting.chating.fragments.OtherTrubuduFragment
import dating.meeting.chating.fragments.PolicyMainCeimpFragment

class PersonalRazvaliliActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_personal_razvalili)
        ...
        the_intent1 = Intent(this, OhCanYouSeeProfileEditActivity::class.java)
        the_fragmentMain = OtherTrubuduFragment()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_help -> {
                the_fragmentMain = PolicyMainCeimpFragment()
                setFragment(the_fragmentMain)
            }

            R.id.nav_sign_out -> {
                the_menuIntent = Intent(this, MainSsOpeActivity::class.java)
