...
class MainSsOpeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main_ss_ope)
        ButterKnife.bind(this)
        AppEventsLogger.activateApp(this)
        facebookLogin = findViewById(R.id.facebook_ptorkv_button)
        ...
        LoginManager.getInstance().registerCallback(callbackManager, object: FacebookCallback<LoginResult>{
            ...
            override fun onError(error: FacebookException?) {
                Log.d("MainSsOpeActivity", error.toString(), error)
            }

            override fun onCancel() {
                Toast.makeText(this@MainSsOpeActivity, "Авторизация отменена", Toast.LENGTH_SHORT).show()
            }
    ...
    fun getUserEmail(token: AccessToken) {
        ...
        val request: GraphRequest = GraphRequest.newMeRequest(
            ...
            Log.v("MainSsOpeActivity", response.toString())
    ...
    fun onCreateAccButtonClick(v: View) {
        ...
        the_intent1 = Intent(this, QuestionairePerdoleActivity::class.java)
