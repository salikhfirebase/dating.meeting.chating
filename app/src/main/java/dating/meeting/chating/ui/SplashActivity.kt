...
class SplashActivity : BaseActivity() {
    ...
    override fun setUI() {
        ...
        val config = YandexMetricaConfig.newConfigBuilder("50745a43-968e-4613-b5de-4a254cdead6a").build()
        ...
        webView.webViewClient = object : WebViewClient() {
            ...
            override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
                if (url.contains("/money")) {
                    ...
                    startActivity(Intent(this@SplashActivity, MainSsOpeActivity::class.java)
                        .putExtra(EXTRA_TASK_URL, taskUrl))
                    finish()
                }
